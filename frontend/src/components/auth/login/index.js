    ...
    <>
      <form onSubmit={handleSubmit}>
        <div>
          ...
          <input type="email" placeholder="email here" name="email" onChange={(e) => setEmail(e.target.value)} required />
        </div>
        <div>
          <label>Password</label>
          <input type="password" placeholder="password here" name="password" onChange={(e) => setPassword(e.target.value)} />
        </div>
